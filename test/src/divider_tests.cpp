...
protected:
    vector<long long> numerators = {5, 9, 17, 933345453464353416L};
    vector<long long> denominators = {2, 3, 19, 978737423423423499L};
    vector<long long> divisions = {2, 3, 0, 0};
    vector<long long> remainders = {1, 0, 17, 933345453464353416};
    ...
    void TearDown() override {
        std::cout << "TearDown() is running." << std::endl;
    };
